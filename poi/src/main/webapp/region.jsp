...
function doSearch() {
		...
		if(rows.length == 0){
			...
			$.messager.confirm("删除确认","你确定要删除选中的取派员吗？",function(r){
				if(r){
					...
					$.post("regionAction_deleteBatch.action",{"ids":ids},function(data){
						//alert(data);
	...
	function saveRegion(){
		$('#form1').form({
			url:'regionAction_save.action',
			onSubmit:function(){//添加表单验证
				
			},
			success:function(data){//回调函数。data为返回json类型
	...
	//修改保存
	function saveRegion1(){
		$('#editRegionForm').form({
			url:'regionAction_exit.action',
			onSubmit:function(){//添加表单验证
...
<body class="easyui-layout" style="visibility: hidden;">
	...
	<div class="easyui-window" title="添加修改区域" id="addRegionWindow"
		...
		<div region="north" style="height: 31px; overflow: hidden;"
			...
			<div class="datagrid-toolbar">
				<a id="save" icon="icon-save" href="#" class="easyui-linkbutton"
					plain="true" onclick="saveRegion()">保存</a>
			</div>
		</div>

		<div region="center" style="overflow: auto; padding: 5px;"
			border="false">
			<form id="form1" action="regionAction_save.action" method="POST">
	...
	<!-- 修改 -->
	<div class="easyui-window" title="修改区域" id="editRegionWindow"
		collapsible="false" minimizable="false" maximizable="false"
		style="top: 20px; left: 200px">
		<div region="north" style="height: 31px; overflow: hidden;"
			split="false" border="false">
			<div class="datagrid-toolbar">
				<a id="save" icon="icon-save" href="#" class="easyui-linkbutton"
					plain="true" onclick="saveRegion1()">保存</a>
			</div>
		</div>
		<div region="center" style="overflow: auto; padding: 5px;"
			border="false">
			<form id="editRegionForm" action="regionAction_exit.action" method="POST">
